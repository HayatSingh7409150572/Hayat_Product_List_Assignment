    ...
    <div class="border-4 bg-gray-100 mr-60 ml-60 p-6 border-solid border-black rounded-md mt-6 ">
        ...
        <table border="2" class="border-2  bg-gray-100 mr-60 ml-32 p-6 border-solid border-black rounded-md mt-8 ">
            ...
            <tr v-for="(item,i) in myarr" :key="item">
                ...
                <td class="border-2  bg-gray-100 p-2 border-solid border-black rounded-md mt-8"><button class=" border-2 font-bold rounded-md bg-red-300  hover:bg-black  text-white p-2 text-center" @click="deletepro(i)">Delete Product</button></td>
                <td class="border-2  bg-gray-100 p-2 border-solid border-black rounded-md mt-8"><button class=" border-2 font-bold rounded-md bg-red-300  hover:bg-black  text-white p-2 text-center" @click="editpro(i)">Edit</button></td>
            </tr>
        </table>
        <div>
            ...
            <button class=" border-2 font-bold rounded-md bg-red-300  hover:bg-black  text-white p-2 text-center" type="search" @click="searchpro">Search</button>
        </div>
    </div>
</div>
</template>
